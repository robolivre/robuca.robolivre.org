...
function BrowserBlocker_Add_Settings_Link($links) {
		$settings_link = '<a href="options-general.php?page=browser-blocker/browser_blocker.php">Settings</a>'; 
...
function BrowserBlocker_Add_Option_Menu() {
		add_submenu_page('options-general.php', 'Browser Blocker', 'Browser Blocker', 8, __FILE__, 'BrowserBlocker_Options_Page');
}
